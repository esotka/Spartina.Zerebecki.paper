...
dat$Flower.yes.1[dat$Total.Seeds.with.zeros==61] <- 1
dat$Total.Seeds.with.zeros[dat$Flower.yes.1==0] <- 0
dat$Total.Seeds.with.zeros[dat$Flower.yes.1==1 & 
                             dat$Total.Seeds.with.zeros==0] <- 1
...
vars <- c("Surivial","Flower.yes.1", "Total.Seeds.with.zeros")
